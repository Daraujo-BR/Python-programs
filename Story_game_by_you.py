...
#Print the story
print('About you:')
print(f'Hey guys, it\'s a pleasure to talk to you. My name is {name} and i am {age} years old. Now I would like to be in {place} with {people}, we would be eating {food}, my favorite food. There, I could {do_there}. But right now ({datetime.date.today()}) i am {do_now}!')